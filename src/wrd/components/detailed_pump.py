...
def build_pump(
    ...
    if stage_num == 3:
        ...
        @blk.unit.Constraint(
            doc="Overall efficiency calculation including motor, VFD, and additional losses"
        )
        def overall_efficiency_constraint(b):
            return b.efficiency_pump[
                0
            ] == b.design_efficiency * b.motor_efficiency * b.vfd_efficiency * (
                1 - b.additional_eff_loss
            )
...
if __name__ == "__main__":
    ...
    for pin in [35.4]:  # [10, 15, 20, 25, 30,35, 40]:
        m = main(
            Qin=2637, Pin=pin * pyunits.psi, stage_num=1, file="wrd_inputs_8_19_21.yaml"
        )
